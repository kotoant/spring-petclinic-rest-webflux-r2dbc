...
public interface VisitsApi {
    ...
    default Mono<ResponseEntity<VisitDto>> addVisit(
    ...
    default Mono<ResponseEntity<VisitDto>> deleteVisit(
    ...
    default Mono<ResponseEntity<VisitDto>> getVisit(
        @Min(0) @Parameter(name = "visitId", description = "The ID of the visit.", required = true, in = ParameterIn.PATH) @PathVariable("visitId") Integer visitId
    ) {
        return Mono.just(new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED));
    ...
    default Mono<ResponseEntity<List<VisitDto>>> listVisits(
    ...
    default Mono<ResponseEntity<VisitDto>> updateVisit(
        @Min(0) @Parameter(name = "visitId", description = "The ID of the visit.", required = true, in = ParameterIn.PATH) @PathVariable("visitId") Integer visitId,
        @Parameter(name = "VisitDto", description = "The visit", required = true) @Valid @RequestBody VisitDto visitDto
    ) {
        return Mono.just(new ResponseEntity<>(HttpStatus.NOT_IMPLEMENTED));
